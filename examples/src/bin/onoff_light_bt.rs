...
use rs_matter::data_model::networks::wireless::{ConnectNetCtl, NoopWirelessNetCtl, WifiNetworks};
...
use rs_matter::data_model::sdm::net_comm::{NetCtl, NetworkType, Networks};
...
fn main() -> Result<(), Error> {
    ...
    let net_ctl = ConnectNetCtl::<NoopRawMutex, _>::new(NoopWirelessNetCtl::new(NetworkType::Wifi));
